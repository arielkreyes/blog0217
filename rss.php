...
$query = "SELECT posts.title, posts.post_id, posts.date, users.email, users.username, 
			posts.body
			FROM posts, users
...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
	<channel>
		...
		<link>http://localhost/melissa-php-0217/blog/</link>
		<description>A practice Blog about nothing</description>
		<atom:link href="http://localhost/melissa-php-0217/blog/rss.php" rel="self" type="application/rss+xml" />

		<?php while( $row = $result->fetch_assoc() ){ ?>
		<item>
			<title><?php echo $row['title']; ?></title>
			<link>http://localhost/melissa-php-0217/blog/single.php?post_id=<?php 
				echo $row['post_id']; ?></link>
			<guid>http://localhost/melissa-php-0217/blog/single.php?post_id=<?php 
